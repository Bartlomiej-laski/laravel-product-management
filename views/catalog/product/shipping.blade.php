<div class="row">
    ...
    <div class="col-7">
        <div class="card">
            <div class="card-header" id="manage-title">
                #MANAGE TITLE <div class="alert alert-info d-none" id="edit-info">Edit mode, <a href="#" data-action="add-new-shipping-mode">add new shipping</a></div>
            </div>
...
<div id="shipping-list-template" class="d-none">
    <li class="list-group-item flex-center-between">
        <label class="switch switch-label switch-primary">
            <input type="checkbox" class="switch-input" name="product-shipping" value="#ShippingID">
            <span class="switch-slider" data-checked="On" data-unchecked="Off"></span>
        </label>
